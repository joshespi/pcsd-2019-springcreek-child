							...
							while ($the_query->have_posts()) : $the_query->the_post();?>
						   		<article class="post">
							   		...
							   		<?php } else { ?>
								   				<a href="<?php the_permalink(); ?>">
												   	<div class="featured-image">
											   			<img src="<?php echo get_stylesheet_directory_uri().'/assets/images/spring-creek-building.jpg'; ?>" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" width="217" height="175">
											   		</div>
